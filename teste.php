		<!-- conteudo index -->
		<div id="content" style="padding:45px 0 0 0; display:block">
			
			<div style="display:inline;  width:489px">
				<iframe width="479" height="325" src="http://www.youtube.com/embed/eSWh9RLWpcg?rel=0" frameborder="0" allowfullscreen></iframe>
			</div>
			
			<div class="introduction" style="width:446px; display:inline; vertical-align:top; margin-left:10px;">
			
				<h1 style="font-size:24px; color:#F58322; margin:0 0 10px 0; padding:0; background-color:red; vertical-align:top">
					Rede Social <span style="color:#E92E91">Um Deus</span>
				</h1>
				...
				<button type="button" class="basic-button" onclick="javascript:window.location='profile-create.php';" title="crie sua conta na rede social UmDeus">começar a usar</button>
		...
		<div style="display:inline; vertical-align:top;">
			...
			<div style="width:400px; background-color:yellow; display:inline; vertical-align:top;">
				<h1>Rede Social Um Deus</h1>
			</div>
			
			<div style="width:400px; background-color:red; display:inline;">
				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam nec mi id leo malesuada lobortis. Integer arcu massa, molestie in bibendum nec, tempus quis leo. Praesent purus nisl, placerat id lacinia vitae, iaculis ut tellus.</p>
