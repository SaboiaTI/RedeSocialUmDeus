...
?>
		...
		<div id="content">
			...
			<div><h1 style="font-size:24px; color:#f58322; margin:0px 0px 25px 0px; padding:0px;">Ajude a manter a rede</h1></div>
			...
			">
				...
				<img src="img/209x48-doar-assina.gif" alt="doar com pagSeguro" title="doações desabilitadas no momento">
				
				<br>
				
				<? if (false) { ?>
				<button type="button" class="basic-button" onclick="" title="Faça uma doação para a Rede Social UmDeus">fazer uma doação agora</button>
				
				<h1 style="font-size:24px; color:#f58322; margin:0px 0px 25px 0px; padding:0px;">Pessoas que ajudaram</h1>
				
				<ul>
					<li>Nome Sobrenome</li>
					<li>Aliquam Tincidunt</li>
					<li>Vestibulum Dapibus</li>
					<li>Nam sed turpis nibh, in adipiscing</li>
					<li>Mauris Facilisis</li>
					<li>Dignissim Congue</li>
					<li>Mauris In Orci</li>
					<li>Iaculis Non</li>
					<li>Dapibus Tristique</li>
				</ul>
				<? } ?>
			</div>
